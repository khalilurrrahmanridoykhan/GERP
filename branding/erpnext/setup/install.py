...
default_mail_footer = """<div style="padding: 7px; text-align: right; color: #888"><small>Sent via
	<a style="color: #888" href="http://frappe.io/erpnext">GMGIERP</a></div>"""
...
def check_frappe_version():
	...
	click.secho(
		f"You're attempting to install GMGIERP version {erpnext_version} with Frappe version {frappe_version}. "
...
def create_custom_company_links():
	...
	with a company in GMGIERP to allow for multitenancy. I.e. one company should
...
def add_app_name():
	frappe.db.set_single_value("System Settings", "app_name", "GMGIERP")
